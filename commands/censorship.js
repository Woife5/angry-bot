...
module.exports = {
	...
	execute(msg, args) {
        ...
        if(subcommand === "add") {
			...
			return msg.channel.send(`Not a valid command. Proper usage would be:\n\`${prefix} ${this.name} ${this.usage}\``);
		}

		writeCache();

		msg.channel.send(`I have ${subcommand === "add" ? "added" : "removed"} \`${emoji}\` to the list of censored emoji:`);
